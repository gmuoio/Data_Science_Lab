...
data_dir <- '/Users/guglielmo/Desktop/DSLAB/data'
setwd(data_dir)

u1_2018 <- read.csv("u1_2018.csv")
u1_2019 <- read.csv("u1_2019.csv")
u1_2020 <- read.csv("u1_2020.csv")
u6_2018 <- read.csv("u6_2018.csv")
u6_2019 <- read.csv("u6_2019.csv")
u6_2020 <- read.csv("u6_2020.csv")
...
#2020: capodanno, giovedì santo e blackout 31 luglio
